...
public class WeeGooAdManager : MonoBehaviour
{
    ...
    public void GAME_LEVEL_START(){
        GameEvent( "game-level-start" );
    }
    public void GAME_LEVEL_FINISHED(){
        GameEvent( "game-level-finished" );
    }
    public void GAME_LEVEL_FAILED(){
        GameEvent( "game-level-failed" );
    }
    public void GAME_LIFE_LOST(){
        GameEvent( "game-life-lost" );
    }
    public void GAME_PAUSE(){
        GameEvent( "game-pause" );
    }
    public void GAME_RESUME(){
        GameEvent( "game-resume" );
    }
    public void GAME_OVER(){
        GameEvent( "game-over" );
    }
    public void GAME_CHECKPOINT(){
        GameEvent( "game-checkpoint" );
    }
    public void GAME_TUTORIAL(){
        GameEvent( "game-tutorial" );
    }
    public void GAME_IAP(){
        GameEvent( "game-iap" );
    }
    public void GAME_ACHIEVEMENT_UNLOCKED(){
        GameEvent( "game-achievement-unlocked" );
    }
    public void GAME_COUNTDOWN(){
        GameEvent( "game-countdown" );
    }
    public void GAME_DAILY_REWARD(){
        GameEvent( "game-daily-reward" );
    }
